  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="<?php echo base_url('admin/home/index'); ?>" class="nav-link <?php echo ($this->uri->segment(2) == "home") ? "active" : null; ?>">
        ...
        <li class="nav-item <?php echo ($this->uri->segment(2) == "exam") ? "menu-is-opening menu-open" : null; ?>">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="<?php echo base_url('admin/exam/create'); ?>" class="nav-link <?php echo ($this->uri->segment(2) == "exam" && $this->uri->segment(3) == "create") ? "active" : null; ?>">
                <i class="far fa-circle nav-icon"></i>
                <p>Add Exam</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?php echo base_url('admin/exam/index'); ?>" class="nav-link <?php echo ($this->uri->segment(2) == "exam" && $this->uri->segment(3) == "index") ? "active" : null; ?>">
                <i class="far fa-circle nav-icon"></i>
                <p>View Exam</p>
              </a>
            </li>
        ...
        <li class="nav-item <?php echo ($this->uri->segment(2) == "question") ? "menu-is-opening menu-open" : null; ?>">
          ...
          <ul class="nav nav-treeview">
            <!-- <li class="nav-item">
              <a href="<?php echo base_url('admin/question/create'); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Add question</p>
              </a>
            </li> -->
            <li class="nav-item">
              <a href="<?php echo base_url('admin/question/index'); ?>" class="nav-link <?php echo ($this->uri->segment(2) == "question" && $this->uri->segment(3) == "index") ? "active" : null; ?>">
                <i class="far fa-circle nav-icon"></i>

      ...
      <div class="col-md-12">
        ...
        <div class="card card-outline card-primary">
          <div class="card-header">
            ...
            <a href="<?php echo base_url('admin/question/index'); ?>" class="col-sm-2 btn btn-info float-right">View Question</a>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form class="form-horizontal" action="<?php echo base_url('admin/question/create') ?>" method="post">
            <div class="card-body">

...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <?php
    $this->load->view("student/home/layout/side_bar_view")
    ?>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        ...
        <?php if ($this->session->flashdata('message') != null) {  ?>
          <div class="alert alert-info alert-dismissable text-sm">
        ...
        <?php if ($this->session->flashdata('exception') != null) {  ?>
          <div class="alert alert-danger alert-dismissable text-sm">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">Online ES</a>.</strong>
